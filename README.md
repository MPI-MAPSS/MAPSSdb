...
![import obj](/MAPSSdb/docs/b-import-dialog.png)
*Import obj*
...
![export menu](/MAPSSdb/docs/d-export-menu.png)
*Export menu*
![export dialog](/MAPSSdb/docs/e-export-dialog.png)
*Export dialog*

That's it. Your 3D model should now display when you upload your .glb file and click `Launch 3D View` in a report.

![launch-3d](/MAPSSdb/docs/f-launch-3d-view.png)
*Launch 3D Viewer*
